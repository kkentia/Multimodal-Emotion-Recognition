...
if __name__ == '__main__':
    ...
    #optimizer = optim.Adam(model.fc.parameters(), lr=LEARNING_RATE)#optimize last layer, changed from model.fc.parameters() to model.parameter() to change every layer
    optimizer = optim.SGD(model.parameters(), lr=LEARNING_RATE, momentum=0.9, weight_decay=1e-4) #changed optimizer for testing 4 better accuracy, as well as full use of AMD gpu
