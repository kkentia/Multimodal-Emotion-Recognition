...
var SPELLS = {
	"Fireball": {
		"scene": load("res://Scences/3d/spells/fireball.tscn"),
	...
	"Confusion": {
		"scene": load("res://Scences/3d/spells/confusion.tscn"),
	...
	"Healing": {
		"scene": load("res://Scences/3d/spells/healing.tscn"),
	...
	"Ice Shard": {
		"scene": load("res://Scences/3d/spells/ice_shard.tscn"),
		"face": "Sad", "voice": "Fear",
		"keyword": "freeze",
		"speed": 70.0,
		"damage": 20
	...
	"Lightning": {
		"scene": load("res://Scences/3d/spells/lightning.tscn"),
	...
	"Shadow Drain": {
		"scene": load("res://Scences/3d/spells/shadow_drain.tscn"),
		"face": "Sad", "voice": "Sad",
		"keyword": "drain",
		"speed": 60.0,
		"damage": 15
...
func cast_spell(spoken_keyword: String):
	...
	# Healing — self-cast, restore player HP
	if spell.speed == 0:
		var main = get_tree().current_scene
		if main.has_method("heal_player"):
			main.heal_player(abs(spell.damage))
		clear_held_spell()
		return
	...
	if spell_to_cast_name == "Shadow Drain":
		spell_instance.drain_on_hit = true
