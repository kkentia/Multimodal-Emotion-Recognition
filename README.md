...
| --- | --- | --- |
| Ana Bog | @kkentia | FER Deep Learning, Game, Bechmarks
| Antonia Spörk | @antoniaspoerk | UI, Video Integration, Audio Integration
| Ali Abdel Ghaffar | @AliAgh123 | SER Deep Learning, User Testing
| Tyler Wilson | @yMakaveli | User Evaluation Analysis
...
**Installation & How to**
 ...
 6. run the train_squeezenet.ipynb to actually train the Squeezenet model.
 7. run FER_SER_UI_godot_bridge.py to start the server that sends the video packages by UDP to a port that the godot script is listening to.
